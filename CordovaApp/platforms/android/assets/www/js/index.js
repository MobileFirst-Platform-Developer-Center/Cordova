...
//        document.getElementById('div_rss').setAttribute('style', 'display:block;');
        //retrieve rss items form json response
        alert("Total RSS Feed Items received:"+response.responseJSON.rss.channel.item.length);
//        WL.Logger.info("Total items to add to the list:"+rssItems.length);
//        var ul = document.getElementById("list_rss");
//        //clear the list before populating it
//        ul.innerHTML="";
//        //populate the list
//         for(var i=0;i<rssItems.length;i++){
//            var li = document.createElement("li");
//            li.appendChild(document.createTextNode(rssItems[i].title));
//            ul.appendChild(li);
//        }
//        // scroll down the screen to make sure the RSS Feed list is visible
